    ...
    module Console
      module CommandDispatcher
        ...
        class Core
          ...
          def cmd_history_tabs(_str, words)
            return [] if words.length > 1
          ...
          def cmd_route(*args)
            ...
            when "print"
              ...
              # Print Route Tables
              print(tbl_ipv4.to_s) if !tbl_ipv4.rows.empty?
              print(tbl_ipv6.to_s) if !tbl_ipv6.rows.empty?
          ...
          def cmd_set(*args)
            ...
            if name.upcase == 'PAYLOAD' && active_module && (active_module.exploit? || active_module.evasion?)
              ...
              index_from_list(payload_show_results, value) do |mod|
                return false unless mod&.respond_to?(:first)
          ...
          def cmd_repeat_tabs(str, _words)
