...
module Rex
  module Post
    module Meterpreter
      ...
      #
      CHANNEL_DIO_READ         = 'read'.freeze
      CHANNEL_DIO_WRITE        = 'write'.freeze
      CHANNEL_DIO_CLOSE        = 'close'.freeze
      ...
      class Channel
        ...
        #
        def initialize(client, cid, type, flags, _packet, **_)
          self.client = client
          self.cid    = cid
          self.type   = type
          self.flags  = flags
        ...
        #
        def synchronous?
          return (flags & CHANNEL_FLAG_SYNCHRONOUS)
        end
